...
// Four main EEG channels on Muse 2
export const MUSE_EEG_TP9_UUID  = "273e0003-4c4d-454d-96be-f03bac821358"; // TP9  (left ear)
export const MUSE_EEG_AF7_UUID  = "273e0004-4c4d-454d-96be-f03bac821358"; // AF7  (left forehead)
export const MUSE_EEG_AF8_UUID  = "273e0005-4c4d-454d-96be-f03bac821358"; // AF8  (right forehead)
export const MUSE_EEG_TP10_UUID = "273e0006-4c4d-454d-96be-f03bac821358"; // TP10 (right ear)
...
// ── Control commands (pre-encoded as base64) ──────────────────────────────────
// Format: [0x02, <cmd_byte>, 0x0a]  — same as muse-lsl _write_cmd_str()
// Start EEG streaming: cmd 'd' (0x64)
export const CMD_START_EEG_B64 = "AmQK";   // btoa(\x02\x64\x0a)
// Stop EEG streaming:  cmd 'h' (0x68)
export const CMD_STOP_EEG_B64  = "AmgK";   // btoa(\x02\x68\x0a)
...
export const EEG_MICROVOLT_SCALE     = 0.48828125; // (raw - 2048) × this → µV
export const EEG_RAW_MIDPOINT        = 2048; // 12-bit midpoint
